...
class DatabaseService {
  ...
  static Future<void> _insertProfanityWords(Database db) async {
    await Future.wait([
      ...
      _generateInsertSQL("stupid", "pg13", db),
      ...
      //anti-lgbtq slurs
      _generateInsertSQL("gay", "anti-lgbtq slurs", db),
      ...
      _generateInsertSQL("lesbian", "anti-lgbtq slurs", db),
      ...
      _generateInsertSQL("jaffa", "religious slurs", db),
      _generateInsertSQL("mormon", "religious slurs", db),
